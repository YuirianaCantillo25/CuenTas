...
function buscarProducto() {
    ...
    fetch(`../php/Caja/buscarCodigo.php?codigo=${codigoProducto}`)
...
function registrarIngreso() {
    ...
    fetch('../php/Caja/guardarSalidas.php', {
        method: 'POST',
...
function guardarGastosAcumulados() {
    ...
    fetch('../php/Caja/guardarGastos.php', {
        method: 'POST',
        body: formDataGastos
    })
...
function cerrarCaja() {
    ...
    fetch('../php/Caja/guardarBalance.php', {
        method: 'POST',
...
function enviarIngresosPendientes() {
    ...
    fetch('../php/Caja/guardarIngresos.php', {
        method: 'POST',
